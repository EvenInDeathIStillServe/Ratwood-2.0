...
/datum/species/arachnid/get_skin_list()
	return list(
...
/datum/species/arachnid/random_name(gender,unique,lastname)
	var/randname
	if(gender == MALE)
		randname = pick(world.file2list("strings/names/roguetown/arachnidmale.txt"))
	if(gender == FEMALE)
		randname = pick(world.file2list("strings/names/roguetown/arachnidfemale.txt"))
	return randname
